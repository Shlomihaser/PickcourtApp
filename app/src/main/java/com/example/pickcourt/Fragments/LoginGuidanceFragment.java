...
public class LoginGuidanceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.layout_login_guidance, container, false);
        findViews(v);
        initViews();
        return v;
    }

    public LoginGuidanceFragment setOpenDrawerCallback(OpenDrawerCallback openDrawerCallback) {
